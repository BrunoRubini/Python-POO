...
lista_usuarios = []
user = clases.Usuario('bruno','apellidoTest',date(1998, 10, 12),12345,'DNI','userBruno','123','br@test.com')
admin = clases.Usuario('adminName','adminApe',date(2023, 5, 3),9999,'PASAPORTE','admin','123','admin@admin.com')
