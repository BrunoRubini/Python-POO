...
lista1= ["ipad","ipod","iphone"]
lista2= ["Reproductor de CD","Videograbadora"]
Compras = {'Mario Pedernera':lista,'Ezequiel Castello':lista1,'Pablo Piristrelli':lista2}

for listaCompra in Compras.items():
    print(listaCompra)
...
print(list(diccionario_6.items()))
# COMPLETAR - FIN
